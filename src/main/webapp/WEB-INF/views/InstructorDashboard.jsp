...
<body>
        ...
        <div id="create-course" class="tab-content active">
            ...
            <form id="courseForm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="contentPath">Course Materials/Files</label>
                        <input type="file" id="contentPath" name="contentPath" class="form-control" 
                               accept=".pdf,.zip,.mp4,.pptx">
                    </div>
                </div>
    ...
    <script>
        ...
        function loadUserInfo() {
            $.ajax({
                ...
                success: function(data) {
                    let displayName = data.username || data.email;
            ...
            $.ajax({
                ...
                success: function(courses) {
                    ...
                    if (!courses || courses.length === 0) {
                        coursesList.html("<p>No courses created yet. <a href='#' onclick=\"showTab('create-course')\">Create your first course</a>!</p>");
                        return;
                    }
                        ...
                        const courseCard = `
                            <div class="course-card">
                                ...
                                <div class="course-actions">
                                    <button class="btn btn-info btn-small" onclick="editCourse(${course.courseId})">
        ...
        function editCourse(courseId) {
            alert(`Edit course ID: ${courseId} - Feature coming soon!`);
        }
