    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .registration-container {
            ...
            padding: 50px; width: 100%; max-width: 700px; margin: 20px;
        ...
        .header h1 { 
            color:#333; font-size:32px; font-weight:700; margin-bottom:10px;
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
        ...
        .form-group label { 
            display:block; margin-bottom:10px; color:#333; font-weight:600; font-size:14px;
            text-transform: uppercase;
            letter-spacing: 0.5px;
        }
        .form-control {
            width:100%; padding:16px 20px; border:2px solid #e1e5e9; border-radius:12px; font-size:16px;
            transition: all .3s cubic-bezier(0.4, 0, 0.2, 1); background-color:#f8f9ff;
        }
        .form-control:focus { 
        ...
        .form-control:hover { border-color:#c1c8d3; transform: translateY(-1px); }
        select.form-control { cursor:pointer; }
        textarea.form-control { resize:vertical; min-height:120px; }
        .form-row { display:flex; gap:20px; }
        .form-row .form-group { flex:1; }
        .role-specific-section {
            background:#f8f9ff; border-radius:12px; padding:25px; margin-top:25px; 
            border-left:4px solid #667eea;
            display:none; animation: slideDown .4s ease-out;
        }
        .role-specific-section.show { display:block; }
        .section-title {
            color:#667eea; font-size:18px; font-weight:600; margin-bottom:20px; 
            display:flex; align-items:center;
        }
        .section-title:before { 
            content:''; display:inline-block; width:4px; height:20px; 
            background:#667eea; margin-right:10px; border-radius:2px; 
        }
        .submit-btn {
            width:100%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); 
            color:#fff; border:none; padding:18px 30px;
            border-radius:12px; font-size:16px; font-weight:600; cursor:pointer; 
            transition: all .3s cubic-bezier(0.4, 0, 0.2, 1); margin-top:25px;
        ...
        .login-link { text-align:center; margin-top:30px; padding-top: 25px;
            border-top: 1px solid #e1e5e9; color:#666; }
        .login-link a { color:#667eea; text-decoration:none; font-weight:600; }
        .login-link a:hover { text-decoration:underline; color: #764ba2; }
        ...
        .alert {
            ...
            animation: slideDown .3s ease-out; position:relative;
        }
        .alert.success { background:#d4edda; border:1px solid #c3e6cb; color:#155724; }
        .alert.error { background:#f8d7da; border:1px solid #f5c6cb; color:#721c24; }
        .alert-close { 
            position:absolute; right:10px; top:10px; cursor:pointer; 
            font-size:18px; line-height:1; color:inherit; opacity:.7; 
        }
        ...
        @media (max-width:768px){
            .registration-container { padding:30px 25px; margin:10px; border-radius: 15px; }
    ...
    <div class="registration-container">
        ...
        <form id="registrationForm" novalidate>
            ...
            <div class="form-group">
                ...
                <select id="userRole" name="role" class="form-control" required onchange="showRoleSpecificSection()">
            ...
            <div id="studentSection" class="role-specific-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="bio" name="bio" class="form-control" 
                              placeholder="Tell us about yourself, your interests, and learning goals..." rows="4"></textarea>
            ...
            <div id="instructorSection" class="role-specific-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="instructorBio" name="instructorBio" class="form-control" 
                              placeholder="Describe your professional background, experience, and teaching philosophy..." rows="5"></textarea>
